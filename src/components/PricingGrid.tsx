        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12">
          {homeData.pricing.map((tier, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className={`relative flex flex-col p-8 sm:p-10 rounded-[40px] border transition-all duration-500 min-h-[600px] cursor-pointer ${tier.popular
                ? 'bg-primary-container border-accent/30 shadow-[0_20px_60px_-15px_rgba(0,242,255,0.2)] -translate-y-3 lg:scale-105 z-10'
